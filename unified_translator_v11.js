...
const fileReplacements = {
  ...
  "Profile.js": [
    ...
    ["Unlocked", "{t('profile.badgesUnlocked')}"],
    ["Locked", "{t('profile.badgesLocked')}"],
    ["All Badges", "{t('profile.badgesAll')}"],
    ["Progress to Unlock", "{t('profile.badgesProgress')}"],
    ["No badges found matching this filter.", "{t('profile.badgesNoBadgesMatching')}"], // Let's use badgesNoBadgesMatching
    ["No notification logs recorded.", "{t('profile.notifsNoNotifs')}"]
  ],
