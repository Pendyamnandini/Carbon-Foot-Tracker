...
const fileReplacements = {
  ...
  "Profile.js": [
    ...
    ["<Typography display=\"block\">Reward Points</Typography>", "<Typography display=\"block\">{t('profile.rewardsPoints')}</Typography>"],
    ["<Typography display=\"block\">Earned Badges</Typography>", "<Typography display=\"block\">{t('profile.tabBadges')}</Typography>"],
    ["<Typography display=\"block\">Certificates</Typography>", "<Typography display=\"block\">{t('profile.certsTitle')}</Typography>"],
    ["<Typography display=\"block\">Global Rank</Typography>", "<Typography display=\"block\">{t('profile.globalRank')}</Typography>"],
