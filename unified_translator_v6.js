...
const fileReplacements = {
  ...
  "Recommendations.js": [
    ...
    // Collision-safe Dialog Category
    ...
    // Collision-safe buttons
    [">Details</Button>", ">{t('recs.actionDetails')}</Button>"],
    [">Later</Button>", ">{t('recs.actionSnooze')}</Button>"],
    [">Ignore</Button>", ">{t('recs.actionIgnore')}</Button>"],
    [">Complete</Button>", ">{t('recs.actionImplement')}</Button>"],
    [">Reactivate</Button>", ">{t('recs.actionReactivate')}</Button>"],
    [">Apply Range</Button>", ">{t('recs.search')}</Button>"],
    [">Log Activity</Button>", ">{t('activity.logBtn')}</Button>"],
    [">Close</Button>", ">{t('recs.dialogClose')}</Button>"]
  ],
  "Leaderboard.js": [
    ["import api from '../api';", "import api from '../api';\nimport { useTranslation } from '../context/LanguageContext';"],
