...
public class ExportV1Controller {
    ...
    @GetMapping("/user")
    public ResponseEntity<?> exportUserReport(@RequestParam(defaultValue = "pdf") String format) {
