...
const fileReplacements = {
  ...
  "Profile.js": [
    ...
    ["Earned {new Date(b.dateEarned).toLocaleDateString()}", "{t('profile.badgesEarnedOn')} {new Date(b.dateEarned).toLocaleDateString()}"],
    ...
    // Interpolated Level progress string replacement
    ...
    ["Dynamic Carbon Achievements & Badges", "{t('profile.badgesTitle')}"],
    ["onClick={() => setBadgesFilter('unlocked')}>Unlocked</Button>", "onClick={() => setBadgesFilter('unlocked')}>{t('profile.badgesUnlocked')}</Button>"],
    ["onClick={() => setBadgesFilter('locked')}>Locked</Button>", "onClick={() => setBadgesFilter('locked')}>{t('profile.badgesLocked')}</Button>"],
    ["onClick={() => setBadgesFilter('all')}>All Badges</Button>", "onClick={() => setBadgesFilter('all')}>{t('profile.badgesAll')}</Button>"],
    ["Progress to Unlock", "{t('profile.badgesProgress')}"],
    ["No badges found matching this filter.", "{t('profile.badgesNoBadgesMatching')}"], 
    ["No notification logs recorded.", "{t('profile.notifsNoNotifs')}"]
  ],
  ...
  "LandingPage.js": [
    ...
    ["Open Codebase Insights", "{t('landing.ctaBtn')}"], // Collision prevent
